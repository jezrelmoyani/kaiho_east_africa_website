    ...
    <div className="space-y-24 bg-white text-slate-700 pb-16">
      ...
      <section className="text-center max-w-5xl mx-auto space-y-8 pt-6 bg-white animate-fadeIn">
        ...
        <div className="space-y-6 max-w-4xl mx-auto pt-4">
          ...
          <p className="text-base sm:text-lg text-slate-500 max-w-2xl mx-auto font-normal leading-relaxed">Skip the sea freight wait. Shop premium Ex-Japan spare parts from our Nairobi warehouse, including engines, gearboxes, body parts, suspension, electrical, and interior components. Our complete engine assemblies come with the gearbox, wiring harness, and ECU, while every part is carefully inspected to ensure quality, reliability, and immediate availability across Kenya.</p>
